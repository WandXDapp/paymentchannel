...
contract('Factory', (accounts) => {
    ...
    it("withdrawFromChannel : withdrawing 100 tokens twice", async()=>{
        ...
        let newsig = web3.eth.sign(accounts[0], newhash);
        await factory.withdrawFromChannel(channelAddress, 200, newsig, {from: receiver});
        assert.strictEqual(new BigNumber(await Token.balanceOf(receiver)).toNumber(), 300);
